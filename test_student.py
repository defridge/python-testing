...
class TestStudent(unittest.TestCase):
    ...
    * Inside test_apply_extension, store end_date for our student instance in a variable called old_end_date
    * Call a method named apply_extension that will take a number of days as an argument on the student instance to update
    the end_date
    ...
    * Use the timedelta method datetime to update the end_date property
